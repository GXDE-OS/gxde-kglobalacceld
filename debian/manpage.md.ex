% gxde-kglobalacceld(SECTION) | User Commands
%
% "April 28 2025"
...
gxde-kglobalacceld - program to do something

# SYNOPSIS

**gxde-kglobalacceld** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gxde-kglobalacceld** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gxde-kglobalacceld** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gxde-kglobalacceld** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gxde-kglobalacceld. See **foo.conf**(5) for further details.
...
**gxde-kglobalacceld** provides some return codes, that can be used in scripts:
